...
tensorUniformRM :: forall s t g m. (StatefulGen g m, UniformRange t, T s t) => (t, t) -> g -> m (Tensor s t)
...
tensorUniformR :: (RandomGen g, UniformRange t, T s t) => (t, t) -> g -> (Tensor s t, g)
